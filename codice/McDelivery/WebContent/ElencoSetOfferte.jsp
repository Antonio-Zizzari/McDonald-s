...
%> 
 <%
 	...
 	if(products == null && error == null) { 		
 		response.sendRedirect(response.encodeRedirectURL("./ProductControlManager?pagina=ElencoSetOfferte"));
 		return;
 	}
	          ...
	          <div class="h-100">
	            ...
	            <div class="card-body ">
	              ...
	              <br>
		      		...
		      		<a href="" data-toggle="modal" data-target="#exampleModalCenter<%=i%>" class="btn btn-warning btn-lg text-center btn-block">Imposta Sconto</a>
				          <div class="modal fade" id="exampleModalCenter<%=i%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
							  <div class="modal-dialog modal-dialog-centered" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="exampleModalLongTitle">Imposta Sconto</h5>
							        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
							          <span aria-hidden="true">&times;</span>
							        </button>
							      </div>
							      <form class="form-signin" action="<%=response.encodeURL("ProductControlManager")%>" method="post">
							      	<input type="text" name="action" value="sconto" style='display: none;'>
							      	<input type="text" name="id" value="<%=bean.getId()%>" style='display: none;'>
							     	 <div class="modal-body">
							      	
									      <div class="form-group">
										      <label for="validationDefault01">Sconto</label>
		    								  <input type="text" class="form-control" id="validationDefault01" name="sconto" required value="<%=bean.getSconto()%>" pattern="[0-9]{1,2}" title="inserire uno sconto valido">
