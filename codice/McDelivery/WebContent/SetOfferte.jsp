...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <strong><h1>Scegli quale catalogo di offerte vuoi impostare</h1></strong>
      <br>

      <div class="row row-cols-1 row-cols-md-3">
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=4")%>">
        ...
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=5")%>">
        ...
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=6")%>">
        ...
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=3")%>">
        ...
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=1")%>">
        ...
        <div class="col mb-4">
          <div class="h-100 prodotti">
            <a href="<%=response.encodeURL("ProdottiOutputServlet?prodotto=2")%>">
